                ...
                <ul>
                  <li>
                    <a href="https://www.facebook.com/sharer?u=<?php echo get_the_permalink(); ?>t=<?php the_title(); ?>" target="_blank" rel="noopener noreferrer">
                      <svg width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="[title]">
                   ...
                   <li>
                    <a title="Compartir en Twitter" href="http://twitter.com/intent/tweet?text=<?php echo get_the_title(); ?>&url=<?php echo get_the_permalink(); ?>" target="_blank" rel="noopener noreferrer">
                      <svg width="32" height="26" viewBox="0 0 32 26" role="img" aria-label="[title]">
                  ...
                  <li>
                    <a href="whatsapp://send?text=<?php the_permalink(); ?>&t=<?php the_title(); ?>" target="_blank" aria-label="WhatsApp">
                      <svg width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="[title]">
